...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"Premium consulting services and technical courses in optimization, AI, and analytics by Allen Ralford Barkley."}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600;700&family=Inter:wght@300;400;500;600&display=swap"}],"style":[],"script":[],"noscript":[],"title":"Allen Ralford Barkley | Premium Consulting & Courses"};
